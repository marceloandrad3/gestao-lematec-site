  ...
  return (
    <div style={{ backgroundColor: "#0f172a", minHeight: "100vh", color: "#e2e8f0" }}>
      <div style={{ maxWidth: "800px", margin: "0 auto", padding: "80px 24px" }}>
        ...
        {[
          { titulo: "1. Identificação do controlador", texto: "Controlador: Lematec LTDA
CNPJ: 54.440.545/0001-48
Endereço: Avenida Guarabira, 932, CXPST 215, João Pessoa – PB, CEP 58038-142
DPO/Contato: contato@gestaolematec.com.br

Esta Política está em conformidade com a LGPD (Lei 13.709/2018)." },
          { titulo: "2. Dados coletados e finalidades", texto: "2.1 AUTENTICAÇÃO (Google OAuth)
Nome, e-mail e foto. Base legal: execução de contrato (art. 7º, V, LGPD).

2.2 DADOS INSERIDOS PELO USUÁRIO
Clientes, orçamentos, serviços, valores financeiros. O USUÁRIO é responsável pela legalidade desses dados.

2.3 DADOS DE USO
Logs, IP, dispositivo, navegador. Base legal: legítimo interesse (art. 7º, IX). Finalidade: segurança e diagnóstico.

2.4 NÃO COLETAMOS
Dados de pagamento (processados pelo Mercado Pago) nem dados sensíveis (art. 5º, II, LGPD)." },
          ...
          { titulo: "4. Compartilhamento", texto: "Dados compartilhados apenas com:
a) Google LLC — infraestrutura Firebase/Cloud Run
b) Mercado Pago — pagamentos
c) Autoridades — quando exigido por lei

NÃO vendemos ou compartilhamos dados para fins comerciais." },
          { titulo: "5. Segurança e retenção", texto: "Infraestrutura Google Cloud com criptografia TLS e em repouso. Dados retidos enquanto a conta estiver ativa. Após cancelamento: 30 dias para exportação, depois excluídos definitivamente.

Nenhum sistema é 100% seguro. O PROVEDOR não garante segurança absoluta." },
          { titulo: "6. Direitos do titular (LGPD)", texto: "Você tem direito a: acesso, correção, eliminação, portabilidade e revogação do consentimento.

Solicite em: contato@gestaolematec.com.br
Prazo de resposta: até 15 dias úteis." },
          ...
          { titulo: "11. Contato e ANPD", texto: "E-mail: contato@gestaolematec.com.br
Responsável: Marcelo Vieira de Andrade

Reclamações também podem ser registradas na ANPD: www.gov.br/anpd" },
        ].map((item, i) => (
