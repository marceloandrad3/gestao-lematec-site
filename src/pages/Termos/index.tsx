const Termos = () => {
  const itens = [
    ...
    { titulo: "10. Disponibilidade, manutenção e restabelecimento", texto: "O PROVEDOR não garante disponibilidade contínua nem tempo máximo de resposta. A plataforma pode ser suspensa para manutenção, atualizações, casos fortuitos, falhas de infraestrutura de terceiros ou determinação judicial. Em caso de indisponibilidade total, o PROVEDOR atuará com diligência para restabelecer o serviço em prazo-alvo de até 30 (trinta) dias corridos, sem que tal prazo constitua garantia contratual, SLA ou obrigação de resultado. Interrupções, de qualquer duração, não geram direito a reembolso, abatimento, multa ou indenização de qualquer natureza, ressalvadas as hipóteses legais inafastáveis." },
