const Termos = () => {
  const itens = [
    ...
    { titulo: "11. Modificações e encerramento", texto: "O PROVEDOR pode a qualquer tempo modificar ou encerrar funcionalidades, alterar a interface e encerrar a plataforma definitivamente, mediante aviso prévio de 30 dias sempre que possível; o aviso prévio fica dispensado quando o encerramento decorrer de fato de terceiros, inviabilidade técnica ou econômica, caso fortuito, força maior ou determinação legal ou judicial. Alterações nos Termos comunicadas por e-mail. Uso continuado implica aceitação." },
