const Termos = () => {
  const itens = [
    ...
    { titulo: "2. Definições", texto: "PLATAFORMA: sistema Gestão Lematec, incluindo web, APK Android e PWA. PROVEDOR: Lematec LTDA, CNPJ 54.440.545/0001-48. USUÁRIO: pessoa física ou jurídica que utiliza a plataforma. DADOS: informações inseridas pelo USUÁRIO. TRIAL: período gratuito de 30 dias." },
