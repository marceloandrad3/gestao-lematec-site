      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 32px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "64px" }}>
          ...
          <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
            <a href="/app" style={{ display: "inline-flex", alignItems: "center", gap: "10px", background: "#1e293b", color: "#facc15", fontSize: "15px", fontWeight: "700", padding: "14px 28px", borderRadius: "12px", border: "2px solid #facc15", textDecoration: "none" }}>
              📲 Instalar o app
            </a>
          </div>
